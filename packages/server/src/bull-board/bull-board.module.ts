...
export class BullBoardModule implements NestModule {
    constructor(@InjectQueue(INVOICE_POLLING_QUEUE_NAME) private readonly invoicePollingQueue: Queue, @InjectQueue(INVOICES_QUEUE_NAME) private readonly invoicesQueue: Queue) {}
