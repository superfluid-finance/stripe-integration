...
import PricingTableEntry from "./PricingTableEntry";

type Props = {
    superfluidProducts: Stripe.Product[];
}
        ...
        <section className="bg-white dark:bg-gray-900">
            <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                ...
                <div className="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
                    ...
                    {
                        superfluidProducts.map(p => <PricingTableEntry key={p.id} product={p} />)
                    }
                    ...
                    {/* <div className="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
                        ...
                        <a href={`${process.env.NEXT_PUBLIC_CHECKOUT_URL}/prod_Os4sqXVSV2dHQd`} className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 w-full">
                            Get Started
                        </a>
                    </div>
