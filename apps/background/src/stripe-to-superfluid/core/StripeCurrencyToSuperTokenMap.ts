...
const defaultChainToSuperTokenMap = new Map<ChainId, Address>([[5, '0x8aE68021f6170E5a766bE613cEA0d75236ECCa9a']]);

export const defaultStripeCurrencyToSuperTokenMap = new Map<StripeCurrencyKey, ChainToSuperTokenMap>([
