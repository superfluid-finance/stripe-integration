...
export type StripeCurrentToSuperTokenMap = Map<
  StripeCurrencyKey,
...
const networkToSuperTokenMap = new Map<ChainID, Address>([
  [5, '0x8aE68021f6170E5a766bE613cEA0d75236ECCa9a'],
]);

const stripeCurrencyToSuperTokenMap = new Map<
  StripeCurrencyKey,
  ChainToSuperTokenMap
>([['usd', networkToSuperTokenMap]]);

const chainToReceiverAddressMap: ChainToReceiverAddressMap = new Map<
  ChainID,
  Address
>([[5, '0xd8dA6BF26964aF9D7eEd9e03E53415D37aA96045']]);

const internalConfig: InternalConfig = {
  stripeSecretKey: ensureDefined(
    process.env.NEXT_PUBLIC_STRIPE_SECRET_KEY_TODO,
  ),
